...
2. View [existing issues](https://github.com/YOUR_USERNAME/peramos-weather-bot/issues)
3. Create a [new issue](https://github.com/YOUR_USERNAME/peramos-weather-bot/issues/new)
